...
def index(request):
    ...
    return render(request, 'shopping/index.html', {'products':products, 'user':user, 'items':items, 'page':'home'})
...
def add_to_cart(request):
    ...
    if user.is_anonymous:
        ...
        password = '1234567a'
        user = User.objects.create(username=user_name, first_name='quest', last_name='quest', email='quest@gmail.com', is_active=True, is_staff=True)
...
def cart(request):
    ...
    return render(request,'shopping/cart.html',{'user':user, 'items':items, 'page':'cart', 'cart_items':cart_items, 'sum':items_sum})
...
def thank_you(request):
    ...
    return render(request, 'shopping/thankyou.html', {'user':user, 'items':items, 'page':'cart', 'cart_items':cart_items, 'sum':items_sum})
...
def confirm_order(request):
    ...
    return render(request, 'shopping/thankyou.html', {'user':user, 'items':0, 'page':'cart', 'cart_items':cart_items, 'sum':items_sum, 'shopping':'Continue Shopping'})
    

def credit_card_page(request):
    return render(request, 'shopping/credit_cart.html', {})
